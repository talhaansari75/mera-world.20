...
//#region node_modules/.nitro/vite/services/ssr/assets/verify.server-CdYricdb.js
...
var auth = betterAuth({
	...
	emailAndPassword: {
		sendResetPassword: async ({ user, url }) => {
			import("./send-Dht8WdzG.mjs").then(({ sendEmail }) => sendEmail({
				to: user.email,
...
//#endregion
export { GROK_PROVIDERS as a, hasGateSessionMarker as i, verify_server_exports as n, auth as r, requireUserId as t };
