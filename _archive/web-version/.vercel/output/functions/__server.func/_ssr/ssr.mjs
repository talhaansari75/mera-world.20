...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CQ8WIwCs.mjs");
...
var manifest = {
	"1ab126d4b4f21473c6c71fd3895cd56a2fdba4037512e843f3171f2fe9368e5f": {
		functionName: "quickMatchMultiplayer_createServerFn_handler",
		importer: () => import("./multiplayer-BiUZCzw1.mjs")
	},
	"1ae3331b7df850b3f79f6b320c0aa1febb8cfb6587b7ca7a38135e0b6f2be03d": {
		functionName: "acceptLegalConsent_createServerFn_handler",
		importer: () => import("./consent-DMeC6OTF.mjs")
	},
	"214e532389d4fd7ac3cf461df51fff915809883bdd8511b99ca25efe6e2ab785": {
		functionName: "recordGameplayAction_createServerFn_handler",
		importer: () => import("./gameplay-BF0n38Gn.mjs")
	},
	"30cdc3d6b014f834542fab2be41d2bffa59815656727d060a199154c71b90160": {
		functionName: "heartbeatMultiplayerRoom_createServerFn_handler",
		importer: () => import("./multiplayer-BiUZCzw1.mjs")
	},
	"36a0d6f1c97d92068a5f4a7080d0ecfcee4f0333332d0828686298ef670d6062": {
		functionName: "getAdminDashboard_createServerFn_handler",
		importer: () => import("./admin-CZ_gjurI.mjs")
	},
	"386132aadfcf0d2dd473368107b506023d01c0217383a58a7358f4f1a586b5d3": {
		functionName: "submitScore_createServerFn_handler",
		importer: () => import("./leaderboard-DaVAQxpc.mjs")
	},
	...
	"654744ea20b062d2b60f2f278bae3afff117b661a98239f16be07de3cbbc8a19": {
		...
		importer: () => import("./ai-fj3-Jbpu.mjs")
	},
	"84d65c1a78229829dd712d3429aa16a1b8a1de59327c6e6aae987486f7469c10": {
		functionName: "trackPlayerActivity_createServerFn_handler",
		importer: () => import("./admin-CZ_gjurI.mjs")
	},
	...
	"b5d203d1dccdc4511217037afc7647adf01f68b90d2db32bc4980d97dda4806a": {
		functionName: "sendMultiplayerRoomMessage_createServerFn_handler",
		importer: () => import("./multiplayer-BiUZCzw1.mjs")
	},
	"bcb3b19a5ce3f7092bc601d9b984b5fa0a76caca6f180c71090d11f5b8db9374": {
		functionName: "getLegalConsent_createServerFn_handler",
		importer: () => import("./consent-DMeC6OTF.mjs")
	},
	...
	"f3c5e9aaa127ec514f1ea5493526ed3212b2b4455e17ab5e3b442432b55c459c": {
		functionName: "updateMultiplayerScore_createServerFn_handler",
		importer: () => import("./multiplayer-BiUZCzw1.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B2-7B2IN.mjs").then((n) => n.t),
