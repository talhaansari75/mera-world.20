...
namespace MeraWorld.Gameplay
{
    ...
    public static class LevelGenerator
    {
        ...
        public static string GetDifficultyForLevel(int levelNumber)
        {
            ...
            if (levelNumber <= 100) return "easy";   // still easy, bigger grid
            if (levelNumber <= 500) return "medium";
            return "hard";
        }

        /// <summary>
        /// Generate a word list for the given level number.
        /// </summary>
        public static List<string> GetWordsForLevel(int levelNumber, List<WordEntry> wordBank)
        {
            ...
            // Fallback: if not enough, mix difficulties
            if (pool.Count < wordCount)
                pool = wordBank.ToList();

            // Deterministic shuffle using level number as seed
        ...
        /// <summary>
        /// Full level generation — grid + words.
        /// </summary>
        ...
        /// <summary>
        /// Parse a simple CSV word bank (word,difficulty,category).
        /// </summary>
